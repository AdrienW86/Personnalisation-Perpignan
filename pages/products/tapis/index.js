                ...
                <div> 
                  ...
                  <div className={styles.box_btn}>
                    {product.options.map((colorOption, index) => (
                      <button
                        key={index}
                        className={`${styles.btn} ${activeItemBtn === index ? styles.activeBtn : ''}`} 
                        onClick={() => handleOptionClick(colorOption.img, index)}
                      >
                        {colorOption.color}
                      </button>
                    ))}
